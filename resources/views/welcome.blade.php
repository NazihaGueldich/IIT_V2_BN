...
@font-face{
    font-family:"Manrope";
    src:url("https://assets.codepen.io/772926/Manrope-Bold.woff2") format("woff2");
    font-weight:700
}
@font-face{
    font-family:"Manrope";
    src:url("https://assets.codepen.io/772926/Manrope-Regular.woff2") format("woff2");
    font-weight:400
}
@font-face{
    font-family:"Manrope";
    src:url("https://assets.codepen.io/772926/Manrope-Light.woff2") format("woff2");
    font-weight:300
}
@font-face{
    font-family:"Manrope";
    src:url("https://assets.codepen.io/772926/Manrope-SemiBold.woff2") format("woff2");
    font-weight:600
}
@font-face{
    font-family:"Manrope";
    src:url("https://assets.codepen.io/772926/Manrope-ExtraLight.woff2") format("woff2");
    font-weight:100
}
*,*::before,*::after{
...
.btn.btn-primary{
    color:#fff;
    background-color:#160d94;
    border-color:#1618bc
}
.btn.btn-primary:hover{
    background-color:#041a60;
    border-color:#6178c1
}
.btn.btn-secondary{
    color:#f1f2f9;
...
<script> function initAcc(elem, option){
...
initAcc('.accordion', false);</script>
