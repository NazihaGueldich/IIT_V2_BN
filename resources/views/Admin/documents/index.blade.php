...
<div class="container-xxl flex-grow-1 container-p-y">
    <br />
    <h1>Liste des documents demandés</h1>
    <br />
            ...
            <table class="table table-hover">
                ...
                <tbody class="table-border-bottom-0">
                    @foreach ($documents as $document)
                        <tr>
                            <td><strong>{{ $document->student->nom . ' ' . $document->student->prenom }}</strong></td>
                            <td>
                            ...
                            <td>
                                <input type="checkbox" class="form-check-input mx-0" onclick="return false;" readonly
                                    <?php $state = $document->urgent > 0 ? 'checked' : '';
                                    echo $state; ?> />
                            </td>
                            <td>
                            ...
                            <td>
                                <a href="{{ route('documents.edit', $document->id) }}" data-method="get"
